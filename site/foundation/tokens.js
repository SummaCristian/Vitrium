...
const NOTES = {
  ...
  '--lg-rim-side-alpha': 'Opacity of the shaded left and right edges of the rim.',
  '--lg-rim-side-x': 'Width of the shaded side edges, in px.',
  ...
  '--lg-rim-sink': 'Tinted glass: lightness of the shaded sides, as a fraction of the tint\'s.',
  '--lg-rim-shade-alpha': 'Tinted glass: opacity of the shaded sides.',
  '--lg-rim-hdr-lift': 'Tinted glass on HDR displays: how far the lit edges start toward white.',
  '--lg-rim-hdr-gain': 'Tinted glass on HDR displays: how far past white the lit edges go.',
  '--lg-rim-clear': 'How strong the rim is on clear glass, as a fraction of regular.',
  '--lg-stroke-clear': 'How strong the stroke is on clear glass, as a fraction of regular.',
  '--lg-shadow-tint': 'Tinted glass: how much of the tint colors the drop shadow (0 is black).',
  '--lg-shadow-tint-alpha': 'Tinted glass: opacity of the colored drop shadow.',
