...
export const start = {
  render(root) {
    root.append(
      ...
      section('Initialize', {}, h('p', {}, 'Import the stylesheet once, then call two setup functions. The first adds press-and-stretch to every element with the `liquid-glass` class. The second checks whether backdrop blur is affordable on this device and switches it on or off.'), codeBlock(`
